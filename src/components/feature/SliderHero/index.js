    ...
    <>
        <div className="slider">
            ...
            <div className="slider--wrapper">
                ...
                <Link className="slider__header__button" to="/community">Subscribe</Link>
                </div>
            </div>
            ...
            <div className="slider--wrapper slider--wrapper--current ">
                <div className="slider__header">
                    ...
                    <Link className="slider__header__button" to="/albums">View Albums</Link>
                </div>
            </div>
        </div>
